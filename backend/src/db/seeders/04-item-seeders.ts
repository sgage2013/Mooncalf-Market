...
module.exports = {
  ...
  },
  {
    ...
    description: "A very rare and unusual core, this fiber produces wands known for their tenacious grip on spells and an affinity for water-based magic. Wands with this core are fiercely loyal, but their wild nature makes them less suited for delicate spells.",
    price: 129.99,
  ...
  {
      name: "Unicorn Hair",
      description: "This core produces the most consistent magic and is the least prone to fluctuations. Wands with this core are the most faithful and are difficult to turn to the Dark Arts. They may not be the most powerful, and can become melancholy if mishandled.",
      price: 49.99,
...
{
  name: "Yew",
  description: "A rare, powerful wand wood. This wand is said to bestow its owner with power over life and death, making it formidable in dueling and protective magic. Wands with this wood often seek out unusual individuals, and are known for their long lives.",
  price: 149.00,
